...
class Stage4Test {
     ...
     */
    @Test
    void stage4() throws InstantiationException, IllegalAccessException {
    ...
    private static DIContainer createDIContainer() throws InstantiationException, IllegalAccessException {
