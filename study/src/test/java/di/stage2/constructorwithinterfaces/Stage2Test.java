...
class Stage2Test {
    ...
    /**
     * 인터페이스를 사용하여 결합도를 낮췄다. 인터페이스를 사용하면 testAnonymousClass 테스트 케이스처럼 개발자가 구현 객체를 바꿔서 사용할 수 있다. 하지만 아직도 문제가 있다. 인터페이스의
     * 구현 객체를 누군가가 결정해줘야 한다. 객체를 생성하고 연결해주는 역할이 필요하다.
     */
    @Test
    void stage2() {
