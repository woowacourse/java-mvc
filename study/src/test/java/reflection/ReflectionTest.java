...
class ReflectionTest {
    ...
    void givenObject_whenGetsFieldNamesAtRuntime_thenCorrect() {
        ...
        final List<String> actualFieldNames = Arrays.stream(fields).map(field -> field.getName()).toList();
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Question secondQuestion = (Question) secondConstructor.newInstance(2L, "gugu", "제목2", "내용2", new Date(),
                0);
