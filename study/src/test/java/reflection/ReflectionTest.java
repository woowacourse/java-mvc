...
class ReflectionTest {
    ...
    void givenObject_whenGetsFieldNamesAtRuntime_thenCorrect() {
        ...
        final Field[] fields = student.getClass().getDeclaredFields(); // private 까지 가져오려면 getDeclared 사용
    ...
    void givenClass_whenGetsMethods_thenCorrect() {
        ...
        final Method[] methods = animalClass.getDeclaredMethods(); // 기본 적으로 상속받은 Object 클래스의 메서드는 가져오지 않으려면 getDeclared 사용
    ...
    void givenClass_whenGetsAllConstructors_thenCorrect() {
        final Class<?> questionClass = Question.class; // 마찬가지로 object class 상속
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        // primitive type에 대해서는 primitive.class 를 사용해야 한다!!!
    ...
    void givenClass_whenGetsDeclaredFields_thenCorrect() {
        final Class<?> questionClass = Question.class;
        final Field[] fields = questionClass.getDeclaredFields(); // private 도 가져옴, 정의된 순서대로
