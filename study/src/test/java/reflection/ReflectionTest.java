...
class ReflectionTest {
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Question secondQuestion = (Question) secondConstructor.newInstance(0, "gugu", "제목2", "내용2",
                new Date(), 0);
    ...
    @Test
    void givenClass_whenGetsFieldsByName_thenCorrect() throws NoSuchFieldException {
        final Class<?> questionClass = Question.class;
