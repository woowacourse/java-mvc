...
class ReflectionTest {
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Question firstQuestion = Question.class.cast(firstConstructor.newInstance("gugu", "제목1", "내용1"));
        final Question secondQuestion = Question.class.cast(secondConstructor.newInstance(1, "gugu", "제목2", "내용2", new Date(), 2));
