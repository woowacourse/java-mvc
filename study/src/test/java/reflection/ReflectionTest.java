...
class ReflectionTest {
    ...
    void givenClass_whenGetsMethods_thenCorrect() {
        ...
        final List<String> actualMethodNames = Arrays.stream(methods)
                .map(Method::getName)
                .toList();
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Constructor<Question> firstConstructor = questionClass
                .getConstructor(String.class, String.class, String.class);
        final Constructor<Question> secondConstructor = questionClass
    ...
    void givenClass_whenGetsPublicFields_thenCorrect() {
        final Class<?> questionClass = Question.class;
        final Field[] fields = questionClass.getFields(); // public fields
    ...
    void givenClassField_whenGetsType_thenCorrect() throws Exception {
        ...
        final Class<?> fieldClass = field.getType(); // 필드의 타입
