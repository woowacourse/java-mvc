...
class ReflectionTest {
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Question firstQuestion =  getQuestionByParameterCount(firstConstructor, 1);
        final Question secondQuestion = getQuestionByParameterCount(secondConstructor, 2);
    ...
    private static Question getQuestionByParameterCount(final Constructor<?> firstConstructor, int number) throws InstantiationException, IllegalAccessException, InvocationTargetException {
        if (firstConstructor.getParameterCount() == 3){
            return (Question) firstConstructor.newInstance("gugu", "제목" + number, "내용" + number);
        } else {
            return (Question) firstConstructor.newInstance(0,"gugu", "제목" + number, "내용" + number,new Date(),0);
        }
    }
