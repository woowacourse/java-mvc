...
class ReflectionTest {
    ...
    void givenObject_whenGetsClassName_thenCorrect() {
        ...
        assertThat(clazz.getSimpleName()).isEqualTo("Question"); // 단순 이름만 반환 (패키지 포함 x)
        assertThat(clazz.getName()).isEqualTo("reflection.Question"); // 패키지 포함한 이름 반환
        assertThat(clazz.getCanonicalName()).isEqualTo("reflection.Question"); // 대부분 getName과 동일 내부 클래스, 익명 클래스를 다룰 때 차이가 있음
    }
    ...
    void givenObject_whenGetsFieldNamesAtRuntime_thenCorrect() {
        ...
        final Field[] fields = student.getClass().getDeclaredFields(); // private 필드를 가져와야하니 getDeclaredFields 사용
