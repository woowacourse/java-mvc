...
class ReflectionTest {
    ...
    void givenObject_whenGetsClassName_thenCorrect() {
        ...
        // getCanonicalName vs getName 의 차이?
    ...
    void givenObject_whenGetsFieldNamesAtRuntime_thenCorrect() {
        ...
        // getFields로는 여기서 접근 가능한 필드만 가져온다.
    ...
    void givenClass_whenGetsMethods_thenCorrect() {
        ...
        // getMethod는 직접 선언한 메서드가 아닌 메서드들도 다 나오는 듯
        final Method[] methods = studentClass.getMethods();
        final List<String> actualMethods = Arrays.stream(methods)
                .filter(method -> method.getDeclaringClass().equals(studentClass))
                .map(Method::getName)
                .toList();
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        // 생성자의 파라미터를 보면 모든 생성자를 구분할 수 있기 떄문인 듯
    ...
    void givenClassField_whenSetsAndGetsValue_thenCorrect() throws Exception {
        ...
        // Field 클래스의 setAccessible과 set 메서드를 활용해서 setter가 열려있지 않은 필드에 값을 셋팅할 수 있구나
