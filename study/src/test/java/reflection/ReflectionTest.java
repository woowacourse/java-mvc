...
class ReflectionTest {
    ...
    void givenObject_whenGetsClassName_thenCorrect() {
        /*
        컴파일 시점에 클래스 타입이 결정됨 → 제네릭 <Question> 사용 가능
        리플렉션 없이도 컴파일러가 클래스 존재를 확인 가능
         */
    ...
    void givenClassName_whenCreatesObject_thenCorrect() throws ClassNotFoundException {
        /*
        문자열로 클래스 이름을 전달 → 런타임에 클래스 로딩
        클래스가 존재하지 않으면 ClassNotFoundException 발생
        런타임에 동적으로 클래스를 로드해야 할 때 사용
         */
