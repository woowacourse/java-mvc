...
class ReflectionTest {
    ...
    void givenObject_whenGetsClassName_thenCorrect() {
        ...
        //TODO getName이랑 getCanonicalName 차이는 뭐지?
        assertAll(
    ...
    void givenObject_whenGetsFieldNamesAtRuntime_thenCorrect() {
        ...
        //TODO getFields() 랑 getDeclaredFields() 의 차이는?
        final Field[] fields = student.getClass().getDeclaredFields();
        final List<String> actualFieldNames = Arrays.stream(fields).map(Field::getName)
                .toList();
    ...
    void givenClass_whenGetsMethods_thenCorrect() {
        ...
        //TODO getMethods() 와 getDeclaredMethods의 차이
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        final Class<?> questionClass = Question.class;
        //TODO getEnclosingConstructor 는 또 뭐야
        ...
        final Question secondQuestion = (Question) secondConstructor.newInstance(0L, "gugu", "제목2",
                "내용2", new Date(), 0);
    ...
    void givenClass_whenGetsPublicFields_thenCorrect() {
        final Class<?> questionClass = Question.class;
        //todo getField 하면 public , getDeclaredFields 하면 private 도 가져오는건가
