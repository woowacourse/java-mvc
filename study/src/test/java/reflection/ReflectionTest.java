...
class ReflectionTest {
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Constructor<?> firstConstructor = questionClass.getConstructor(new Class[]{String.class, String.class, String.class});
        final Constructor<?> secondConstructor = questionClass.getConstructor(new Class[]{String.class, String.class, String.class});
