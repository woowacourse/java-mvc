...
class ReflectionTest {
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Constructor<?> firstConstructor = questionClass.getDeclaredConstructor(long.class, String.class,
        ...
        final Question firstQuestion = (Question) secondConstructor.newInstance("gugu", "제목1", "내용1");
        final Question secondQuestion = (Question) firstConstructor.newInstance(1L, "gugu", "제목2", "내용2", new Date(),
                0);
