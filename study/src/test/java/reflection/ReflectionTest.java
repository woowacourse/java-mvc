...
class ReflectionTest {
	...
	void givenObject_whenGetsFieldNamesAtRuntime_thenCorrect() {
		...
		// Student의 필드는 private이므로, getDeclaredFields()를 이용한다.
	...
	void givenClass_whenGetsMethods_thenCorrect() {
		...
		// getAge, getName, toString이 public이지만,
		// 상속받은 wait와 같은 메서드는 포함하지 않기 위해 getDeclaredMethods()를 사용한다.
	...
	void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
		...
		Constructor<?> constructor = questionClass.getDeclaredConstructor(String.class, String.class, String.class);
