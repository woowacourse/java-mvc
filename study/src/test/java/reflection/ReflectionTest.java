...
class ReflectionTest {
    ...
    void givenObject_whenGetsFieldNamesAtRuntime_thenCorrect() {
        ...
        final List<String> actualFieldNames = Arrays.stream(fields).map(it -> it.getName()).collect(Collectors.toList());
    ...
    void givenClass_whenGetsMethods_thenCorrect() {
        ...
        final List<String> actualMethods = Arrays.stream(methods).map(it -> it.getName()).collect(Collectors.toList());
