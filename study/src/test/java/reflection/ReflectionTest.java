...
class ReflectionTest {
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        log.info("firstConstructor: {}", Arrays.toString(firstConstructor.getParameterTypes()));
        log.info("secondConstructor: {}", Arrays.toString(secondConstructor.getParameterTypes()));
