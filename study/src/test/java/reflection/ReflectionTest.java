...
class ReflectionTest {
    ...
    void givenObject_whenGetsClassName_thenCorrect() {
        ...
        var subclazz = TestClass.InnerClass.class;

        // 단순 클래스명
        assertThat(clazz.getSimpleName()).isEqualTo("Question");
        assertThat(subclazz.getSimpleName()).isEqualTo("InnerClass");

        // 패키지명을 포함한 클래스명, 내부 클래스인 경우 $를 표시 -> com.example.TestClass$InnerClass
        assertThat(clazz.getName()).isEqualTo("reflection.Question");
        assertThat(subclazz.getName()).isEqualTo("com.example.TestClass$InnerClass");

        // 패키지명을 포함한 클래스명, 내부 클래스인 경우에도 .으로 구분 -> com.example.TestClass.InnerClass
        assertThat(clazz.getCanonicalName()).isEqualTo("reflection.Question");
        assertThat(subclazz.getCanonicalName()).isEqualTo("com.example.TestClass.InnerClass");
    }
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Question secondQuestion = (Question) secondConstructor.newInstance(
                1L, "gugu", "제목2", "내용2", new Date(10000), 1);
