...
class ReflectionTest {
    ...
    void givenObject_whenGetsClassName_thenCorrect() {
        ...
        assertThat(clazz.getSimpleName()).isEqualTo("Question"); // 클래스명만
        assertThat(clazz.getName()).isEqualTo("reflection.Question"); // 패키지 경로를 포함한 클래스의 전체 이름 (이너클래스는 $로 구분)
        /*
            패키지 경로를 포함한 클래스의 전체 이름 (이너클래스는 $로 구분)
            익명 클래스와 로컬 클래스의 경우, getCanonicalName()은 null을 반환
        */
    ...
    void givenClassName_whenCreatesObject_thenCorrect() throws ClassNotFoundException {
        // 패키지 이름을 포함한 클래스의 정식 이름으로 클래스 메타데이터를 찾음
    ...
    void givenObject_whenGetsFieldNamesAtRuntime_thenCorrect() {
        ...
        /*
         * getFields() : public 필드를 반환
         * getDeclaredFields() : 모든 필드를 반환
         * */
    ...
    void givenClass_whenGetsAllConstructors_thenCorrect() {
        ...
        /*
         * getConstructors() : public 생성자를 반환
         * getDeclaredConstructors() : 모든 생성자를 반환
         * */
    ...
    void givenClassField_whenSetsAndGetsValue_thenCorrect() throws Exception {
        ...
        final Student student = (Student) studentClass.getConstructor()
                .newInstance();
