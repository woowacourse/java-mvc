...
class ReflectionTest {
    ...
    void givenObject_whenGetsFieldNamesAtRuntime_thenCorrect() {
        ...
        final List<String> actualFieldNames = List.of(fields[0].getName(), fields[1].getName());
    ...
    void givenClass_whenGetsMethods_thenCorrect() {
        ...
        final List<String> actualMethods = List.of(methods[0].getName(), methods[1].getName(), methods[2].getName());
