...
class ReflectionTest {
    ...
    void givenObject_whenGetsFieldNamesAtRuntime_thenCorrect() {
        //getDeclaredFields()는 해당 클래스에 직접 선언된 모든 필드를 반환
        //getFields()는 해당 클래스와 상속받은 모든 public 필드를 반환
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Question secondQuestion = (Question) secondConstructor.newInstance(1L, "gugu", "제목2", "내용2", Date.from(Instant.now()), 1);
