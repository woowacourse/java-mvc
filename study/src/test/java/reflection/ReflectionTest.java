...
class ReflectionTest {
    ...
    void givenObject_whenGetsFieldNamesAtRuntime_thenCorrect() {
        ...
        final Field[] fields = student.getClass().getDeclaredFields();  // 정의된 모든 필드
        // getFields = public 필드만
    ...
    void givenClass_whenGetsMethods_thenCorrect() {
        ...
        final Method[] methods = animalClass.getDeclaredMethods();  // getMethods는 상속받은 메서드까지 포함
        // getDeclaredMethods는 해당 클래스에서 직접 정의된 메소드들
    ...
    void givenClass_whenGetsAllConstructors_thenCorrect() {
        ...
        // getDeclaredConstructors - 모든 생성자
    ...
    void givenClassField_whenSetsAndGetsValue_thenCorrect() throws Exception {
        ...
        // student 인스턴스의 필드값(age)를 99로 변경
