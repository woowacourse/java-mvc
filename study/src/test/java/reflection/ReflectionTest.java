...
class ReflectionTest {
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Constructor<?> firstConstructor = Arrays.stream(questionClass.getConstructors()).toList().getFirst();
        final Constructor<?> secondConstructor = Arrays.stream(questionClass.getConstructors()).toList().get(1);
