...
class ReflectionsTest {
    ...
    void showAnnotationClass() throws Exception {
        ...
        final Set<Class<?>> serviceAnnotatedClasses = reflections.getTypesAnnotatedWith(Service.class);
        final Set<Class<?>> repositoryAnnotatedClasses = reflections.getTypesAnnotatedWith(Repository.class);
