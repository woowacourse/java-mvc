...
public class LoginController {
    ...
    public ModelAndView login(final HttpServletRequest req, final HttpServletResponse res) throws Exception {
        ...
        View view = InMemoryUserRepository.findByAccount(req.getParameter("account"))
                .map(user -> {
                    log.info("User : {}", user);
                    return createView(req, user);
                })
    ...
    private View createView(final HttpServletRequest request, final User user) {
