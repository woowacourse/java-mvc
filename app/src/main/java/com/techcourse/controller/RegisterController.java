...
import static com.techcourse.controller.JspConstants.REGISTER_JSP;
...
public class RegisterController {
    ...
    public ModelAndView renderRegisterView(final HttpServletRequest req, final HttpServletResponse res) {
