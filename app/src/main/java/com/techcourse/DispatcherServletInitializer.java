...
public class DispatcherServletInitializer implements WebApplicationInitializer {
    ...
    public void onStartup(final ServletContext servletContext) {
        ...
        final var handlerMappingRegistry = WebMvcConfiguration.handlerMappingRegistry();
        final var handlerAdapterRegistry = WebMvcConfiguration.handlerAdapterRegistry();
