...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
                ...
                <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="/myinfo.jsp">내정보</a></li>
            ...
            <% } else { %>
            <div class="navbar-nav d-none d-md-inline-block ms-auto me-0 me-md-3 my-2 my-md-0">
                <a class="nav-link" href="/register" methods="GET" role="button"><i class="fas fa-user fa-fw"></i>&nbsp;회원가입</a>
            </div>
            <div class="navbar-nav d-none d-md-inline-block ms-auto me-0 me-md-3 my-2 my-md-0">
                <a class="nav-link" href="/login" methods="GET" role="button"><i class="fas fa-user fa-fw"></i>&nbsp;로그인</a>
            </div>
            <% } %>
        </nav>
