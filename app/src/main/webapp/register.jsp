                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">회원 가입</h3>
                                    </div>
                                    <div class="card-body">
                                        <form method="post" action="/register">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputLoginId" name="account" type="Text"
                                                       placeholder="아이디를 입력하세요" /> <label for="inputLoginId">아이디</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid">
                                                    <button class="btn btn-primary btn-block" type="submit">가입하기
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
