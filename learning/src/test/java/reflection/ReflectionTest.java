...
class ReflectionTest {
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        Object[] args = {1L, "gugu", "제목2", "내용2", new Date(1L), 0};
        final Question secondQuestion1 = (Question) secondConstructor.newInstance(args);

        final Question secondQuestion = (Question) secondConstructor.newInstance(1L, "gugu", "제목2", "내용2", new Date(0L), 0);
        ...
        assertThat(secondQuestion1.getWriter()).isEqualTo("gugu");
        assertThat(secondQuestion1.getTitle()).isEqualTo("제목2");
        assertThat(secondQuestion1.getContents()).isEqualTo("내용2");
    }
