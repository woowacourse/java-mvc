...
class ReflectionTest {
    ...
    void givenClass_whenGetsMethods_thenCorrect() {
        ...
        final List<String> actualMethods = Arrays.stream(animalClass.getDeclaredMethods())
            .map(Method::getName)
            .collect(Collectors.toList());
    ...
    void givenClassField_whenSetsAndGetsValue_thenCorrect() throws Exception {
        ...
        final Field field = findAge(declaredFields);
    ...
    private Field findAge(Field[] declaredFields) {
