...
class ReflectionTest {
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Question secondQuestion = (Question) secondConstructor.newInstance(arg2);
    ...
    private static List<String> getMethodNames(final Method[] methods) {
    ...
    private static List<String> getFieldNames(final Field[] fields) {
