...
class ReflectionTest {
    ...
    void givenClass_whenGetsMethods_thenCorrect() {
        ...
        final List<String> actualMethods = Arrays.stream(methods).map(Method::getName)
            .collect(Collectors.toList());
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Question secondQuestion = (Question) secondConstructor.newInstance(1L, "gugu", "제목2", "내용2", new Date(System.currentTimeMillis()), 0);
    ...
    void givenClassField_whenSetsAndGetsValue_thenCorrect() throws Exception {
        ...
        final Student student = (Student) studentClass.getDeclaredConstructors()[0].newInstance();
