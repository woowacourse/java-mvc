...
class ReflectionTest {
    ...
    void givenClassName_whenCreatesObject_thenCorrect() throws ClassNotFoundException {
        ...
        assertThat(clazz.getSimpleName()).isEqualTo(Question.class.getSimpleName());
        assertThat(clazz.getName()).isEqualTo(Question.class.getName());
        assertThat(clazz.getCanonicalName()).isEqualTo(Question.class.getCanonicalName());
    }
