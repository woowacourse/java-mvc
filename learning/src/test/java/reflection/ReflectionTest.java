...
class ReflectionTest {
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Question secondQuestion = (Question) secondConstructor.newInstance(2L, "gugu", "제목2", "내용2", null, 5);
        ...
        assertThat(secondQuestion.getQuestionId()).isEqualTo(2L);
        assertThat(secondQuestion.getCountOfComment()).isEqualTo(5);
    }
    ...
    void givenClassField_whenSetsAndGetsValue_thenCorrect() throws Exception {
        ...
        final Field field = Arrays.stream(student.getClass().getDeclaredFields())
            .filter(declaredField -> declaredField.getName().equals("age"))
            .findAny()
