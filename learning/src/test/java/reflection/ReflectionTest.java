...
class ReflectionTest {
    ...
    void givenClass_whenGetsAllConstructors_thenCorrect() {
        ...
        /**
         * getConstructors(): public 생성자인 경우만 조회 O
         * getDeclaredConstructors(): public/protected/private 생성자 전부 조회 O
         */
    ...
    void givenClass_whenInstantiatesObjectsAtRuntime_thenCorrect() throws Exception {
        ...
        final Question firstQuestion = (Question) firstConstructor
            .newInstance("gugu", "제목1", "내용1");
        final Question secondQuestion = (Question) secondConstructor
            .newInstance(0, "gugu", "제목2", "내용2", null, 0);
