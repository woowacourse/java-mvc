...
class HandlerAdapterRegistryTest {
    ...
    void getHandlerAdapter() {
        ...
        HandlerAdapter handlerAdapter = handlerAdapterRegistry.getHandlerAdapter(new TestHandlerMapping());
    ...
    void cantGetHandlerAdapter() {
        ...
        assertThatThrownBy(
            () -> handlerAdapterRegistry.getHandlerAdapter(new TestHandlerMapping()))
