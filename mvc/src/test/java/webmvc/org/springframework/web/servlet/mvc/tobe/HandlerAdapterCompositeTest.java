...
class HandlerAdapterCompositeTest {
    ...
    private final HandlerAdapter HYENA_HANDLER_ADAPTER = new HandlerAdapter() {
        @Override
    ...
    private final HandlerAdapter HERB_HANDLER_ADAPTER = new HandlerAdapter() {
        @Override
        public boolean support(final Object handleExecution) {
    ...
    void setUp() {
        ...
        handlerAdapterComposite.addHandlerAdapter(HYENA_HANDLER_ADAPTER);
        handlerAdapterComposite.addHandlerAdapter(HERB_HANDLER_ADAPTER);
    }
