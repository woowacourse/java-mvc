...
public final class AnnotationHandlerMapping implements HandlerMapping {
    ...
    public void initialize() {
        ...
        registerHandlersFromControllers(controllers);
    ...
    private void registerHandlersFromControllers(final Map<Class<?>, Object> controllers) {
        for (final Class<?> controllerClass : controllers.keySet()) {
            final Object controllerInstance = controllers.get(controllerClass);
